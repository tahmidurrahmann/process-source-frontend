        ...
        <div className="pt-20">
            <footer className="footerr mt-20">
                ...
                <div className="py-16 lg:px-8 w-4/5 space-y-6 max-w-screen-xl">
                    ...
                    >
                        <div>
                            <p className="font-semibold text-[#FFFFFF59]">Services</p>
                        ...
                        <div>
                            <p className="font-semibold text-[#FFFFFF59]">Company</p>
                        ...
                        <div>
                            <p className="font-semibold text-[#FFFFFF59]">Helpful Links</p>
                    ...
                    <p className="text-xs">&copy; 2024. Process Source. All rights reserved.</p>
                </div>
            </footer>
        </div>
    );

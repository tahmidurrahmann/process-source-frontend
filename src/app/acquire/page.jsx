        ...
        <div>
            <div className="background14 text-white">
                <div className="max-w-screen-2xl mx-auto xl:space-y-3 py-28 lg:py-48">
                    ...
                    <p className="2xl:px-0 text-sm pt-4 lg:text-xl px-12 md:px-16 md:w-3/4 lg:w-4/5">Flexible solutions to keep your contact centre or back-office operations up and running remotely with Acquire@Home.</p>
            ...
            <div className="flex flex-col md:flex-row gap-6 md:gap-8 lg:gap-12 justify-center max-w-screen-2xl mx-auto font-extralight pt-12 2xl:px-0 md:px-16">
                ...
                <div>
                    <h1 className="text-[#68398e] text-2xl text-center md:text-left pb-4 px-12 2xl:px-0 md:px-16">Acquire@Home</h1>
                    <p className="text-white px-12 2xl:px-0 md:px-16">At Acquire BPO, we understand the importance of business continuity. Our Acquire@Home engagement model enables you to respond rapidly to market demands or unexpected events such as the global COVID-19 crisis, which has shifted most people from a traditional office environment to a home-based arrangement.</p>
                    <p className="text-white px-12 2xl:px-0 md:px-16">With Acquire@Home, your campaign will leverage the same rigorous operational standards, redundant network connectivity and continuous improvement initiatives that you’d find in any of our delivery centres—all from the safety and security of our employees’ homes so your business never misses a step.</p>

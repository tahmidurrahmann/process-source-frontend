...
const Engagement = () => {
    return (
        <div className="bg-[#003468] -mt-[6px]">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2">
                    <div className="relative">
                        ...
                        <div className="absolute bottom-0 space-y-2 p-10 md:p-16 lg:p-10 xl:p-20 bg-gradient-to-b from-transparent via-[#15151588] to-black w-full h-full">
                            ...
                            <button className="bg-[#0C71C3] text-sm xl:text-base hover:bg-transparent hover:border-2 my-4 px-5 py-2 rounded-full font-bold uppercase -mb-8">Get Started</button>
                        </div>
                    </div>
                    <div className="relative">
                        ...
                        <div className="absolute bottom-0 space-y-2 p-10 md:p-16 lg:p-10 xl:p-20 bg-gradient-to-b from-transparent via-[#151515a5] to-black w-full h-full">
                            ...
                            <button className="bg-[#0C71C3] text-sm xl:text-base hover:bg-transparent hover:border-2 my-4 px-5 py-2 rounded-full font-bold uppercase -mb-8">Let's Partner</button>
                        </div>
                    </div>
                    <div className="relative">
                        ...
                        <div className="absolute bottom-0 space-y-2 p-10 md:p-16 lg:p-10 xl:p-20 bg-gradient-to-b from-transparent via-[#15151583] to-black w-full h-full">
                            ...
                            <button className="bg-[#0C71C3] text-sm xl:text-base hover:bg-transparent hover:border-2 my-4 px-5 py-2 rounded-full font-bold uppercase -mb-8">Go Remote</button>
                        </div>
                    </div>
                    <div className="relative">
                        ...
                        <div className="absolute bottom-0 space-y-2 p-10 md:p-16 lg:p-10 xl:p-20 bg-gradient-to-b from-transparent via-[#151515c0] to-black w-full h-full">
                            ...
                            <button className="bg-[#0C71C3] text-sm xl:text-base hover:bg-transparent hover:border-2 my-4 px-5 py-2 rounded-full font-bold uppercase -mb-8">Work Here</button>
                        </div>
                    </div>
                </div>
            </div>

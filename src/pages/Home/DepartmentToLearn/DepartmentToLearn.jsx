...
const DepartmentToLearn = () => {
    ...
    return (
        <div>
            <div className="background17 text-white">
                <div className="max-w-screen-2xl mx-auto xl:space-y-3 py-12 lg:py-28">
                    <div className="max-w-screen-xl mx-auto px-6 2xl:px-0">
                        <h1 className="mx-12 pb-8 lg:mt-24 text-3xl md:text-4xl text-center xl:text-5xl font-semibold">Choose a department to <br /> Learn More</h1>
                        <Tabs>
                            <TabList className="flex items-center justify-center lg:gap-6 overflow-x-auto">
                                <Tab onClick={() => handleTabClick(0)} className={activeTab === 0 ?`flex items-center gap-4 border-t-8 border-t-[#006aff] bg-[#006aff] rounded-bl-lg xl:py-4 xl:px-8 font-bold` : `border-t-8 bg-white text-black rounded-bl-lg font-bold border-t-[#006aff] flex items-center gap-4 xl:py-4 xl:px-8`}><FaHeadphones size={26} />Customer Support</Tab>
                                <Tab onClick={() => handleTabClick(1)} className={activeTab === 1 ? `flex items-center gap-4 border-t-8 border-t-[#006aff] bg-[#006aff] rounded-bl-lg xl:py-4 xl:px-8 font-bold` : `border-t-8 bg-white text-black rounded-bl-lg font-bold border-t-[#006aff] flex items-center gap-4 xl:py-4 xl:px-8`}> <FaCalculator size={26}  />Finance & Accounting</Tab>
                                <Tab onClick={() => handleTabClick(2)} className={activeTab === 2 ? `flex items-center gap-4 border-t-8 border-t-[#006aff] bg-[#006aff] rounded-bl-lg xl:py-4 xl:px-8 font-bold` : `border-t-8 bg-white text-black rounded-bl-lg font-bold border-t-[#006aff] flex items-center gap-4 xl:py-4 xl:px-8`}><FaLaptop size={26}  />Other Back-office</Tab>
                                <Tab onClick={() => handleTabClick(3)} className={activeTab === 3 ? `flex items-center gap-4 border-t-8 border-t-[#006aff] bg-[#006aff] rounded-bl-lg xl:py-4 xl:px-8 font-bold` : `border-t-8 bg-white text-black rounded-bl-lg font-bold border-t-[#006aff] flex items-center gap-4 xl:py-4 xl:px-8`}><GoGraph size={26}  />Customer Success</Tab>
                                <Tab onClick={() => handleTabClick(4)} className={activeTab === 4 ? `flex items-center gap-4 border-t-8 border-t-[#006aff] bg-[#006aff] rounded-bl-lg xl:py-4 xl:px-8 font-bold` : `border-t-8 bg-white text-black rounded-bl-lg font-bold border-t-[#006aff] flex items-center gap-4 xl:py-4 xl:px-8`}><BiPhoneCall size={26}  />Sales & Revenue</Tab>
                                <Tab onClick={() => handleTabClick(5)} className={activeTab === 5 ?`flex items-center gap-4 border-t-8 border-t-[#006aff] bg-[#006aff] rounded-bl-lg xl:py-4 xl:px-8 font-bold` : `border-t-8 bg-white text-black rounded-bl-lg font-bold border-t-[#006aff] flex items-center gap-4 xl:py-4 xl:px-8`}><RxSpeakerLoud size={26} />Marketing</Tab>
                            </TabList>
